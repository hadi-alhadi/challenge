...
const Carousel: React.FC = () => {
    ...
    if (error) {
        return <div className="error">Sorry, an error occurred while fetching the discounts. Please try again later.</div>;
    }
                        ...
                        {data.map((discount) => (
                            <SwiperSlide key={discount.id}>
                                <div className="slide-content">
                                    ...
                                    <div className="slide-discount">{discount.discount_percentage}%</div>
                                </div>
                            </SwiperSlide>
                        ))}
                    </Swiper>
